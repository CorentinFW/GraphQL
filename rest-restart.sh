...
# Script de redémarrage avec persistance des données
# Relance : Hôtels + Agences + Client GUI
# Base de données : CONSERVÉE (persistance)
...
echo "╚═══════════════════════════════════════════════════════════════╝"
echo ""
echo "✅ Les bases de données H2 seront CONSERVÉES"
...
# Afficher l'état des bases de données
