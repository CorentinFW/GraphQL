...
import org.tp1.client.graphql.MultiAgenceGraphQLClient;
...
public class ClientGUI {
    ...
    @Autowired
    private MultiAgenceGraphQLClient agenceGraphQLClient;
    ...
    private void testConnexion() {
        new SwingWorker<String, Void>() {
            ...
            protected String doInBackground() throws Exception {
                return agenceGraphQLClient.ping();
            }
    ...
    private void effectuerReservation(ChambreDTO chambre, String nom, String prenom,
        ...
        new SwingWorker<ReservationResponse, Void>() {
            ...
            protected ReservationResponse doInBackground() throws Exception {
                return agenceGraphQLClient.effectuerReservation(
                    nom,
                    prenom,
                    nom + "@example.com",  // Email (généré)
    ...
    */
    ...
    private void afficherHotelsOLD() {
        new SwingWorker<List<String>, Void>() {
            @Override
            protected List<String> doInBackground() throws Exception {
                // return agenceGraphQLClient.getHotelsDisponibles();
    ...
    */
    ...
    private void afficherAPropos() {
        String message = "Système de Réservation Multi-Agences\n\n" +
                        "Version 3.1 - Interface Graphique\n" +
